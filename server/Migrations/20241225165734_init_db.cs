        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Settings_Settings_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(511)", maxLength: 511, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Settings_CategoryId",
            ...
            migrationBuilder.InsertData(
                table: "BaseProducts",
                columns: new[] { "BaseProductId", "Description", "ProductName" },
                values: new object[] { 1, null, "Base Product 1" });

            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "SettingId", "Description", "Name", "Status", "TypeId", "Value" },
                values: new object[,]
                {
                    { 1, "", "Category", true, null, "" },
                    { 2, "", "PaymentMethod", true, null, "" },
                    { 3, "", "OrderStatus", true, null, "" },
                    { 4, "", "Size", true, null, "" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "BaseProductId", "CategoryId", "MainImageId", "Price", "Status" },
                values: new object[,]
                {
                    { 1, 1, null, null, 100m, true },
                    { 2, 1, null, null, 200m, true }
                });
